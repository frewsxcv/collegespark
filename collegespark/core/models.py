...
class UserManager(BaseUserManager):
    def create_user(self, email, username, school, password=None):
        user = self.model(email=UserManager.normalize_email(email), username=username, school=school)
    ...
    def create_superuser(self, email, username, password):
        ...
        user = self.create_user(email, password=password, username=username, school=school)
        user.is_admin = True
        user.save(using=self._db)
        return user
